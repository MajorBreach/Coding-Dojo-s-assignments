...
-- SELECT 
--     countries.name AS country, COUNT(cities.id) AS number_cities
-- FROM
--     countries
--         JOIN
...
--     cities
--         JOIN
--     countries ON cities.country_id = country_id
-- WHERE
...
-- SELECT 
--     countries.name, languages.percentage
-- FROM
--     countries
--         JOIN
--     languages ON countries.code = languages.country_code
-- WHERE
--     languages.percentage > 85
...
SELECT 
    region, COUNT(id) AS number_countries
FROM
    countries
GROUP BY region
ORDER BY COUNT(id) DESC
-- had help from jacob/anthony--  